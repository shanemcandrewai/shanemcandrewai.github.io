...
const matcaps = (function () {
  return {
    none: null,
    porcelainWhite: textureLoader.load('./img/matcap-porcelain-white.jpg'),
  };
}());

const alphaMaps = (function () {
  const fibers = textureLoader.load('./img/alphaMap.jpg');
...
const gradientMaps = (function () {
  const threeTone = textureLoader.load('./img/threeTone.jpg');
  threeTone.minFilter = THREE.NearestFilter;
  threeTone.magFilter = THREE.NearestFilter;

  const fiveTone = textureLoader.load('./img/fiveTone.jpg');
