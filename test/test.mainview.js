...
suite('MainView', () => {
  ...
  test('archive single log', async () => {
    ...
    mainview.dataview.data.get('parent').get('elemID').value = '';
    mainview.dataview.data.get('priority').get('elemID').value = '';
    mainview.dataview.data.get('description').get('elemID').value = 'log';
    mainview.dataview.data.get('due').get('elemID').value = '';
    mainview.controlview.insertListener();
    mainview.controlview.newListener();
    mainview.dataview.data.get('description').get('elemID').value = 'archive';
    mainview.controlview.insertListener();
    mainview.controlview.newListener();
    mainview.dataview.data.get('parent').get('elemID').value = 1;
    mainview.dataview.data.get('description').get('elemID').value = 'log1';
    mainview.controlview.insertListener();
    mainview.controlview.archiveListener();
    mainview.controlview.upListener();
    chai.assert.equal(mainview.dataview.data.get('id').get('elemID').value, 100000);
    chai.assert.equal(mainview.dataview.data.get('description').get('elemID').value, 'log');
    mainview.controlview.downListener();
    chai.assert.equal(mainview.dataview.data.get('id').get('elemID').value, 100001);
    chai.assert.equal(mainview.dataview.data.get('description').get('elemID').value, 'log1');
    chai.assert.equal(mainview.controlview.db.getRec(3), undefined);
  });
  test('archive 2 logs', async () => {
    ...
    mainview.controlview.insertListener();
    mainview.controlview.newListener();
    mainview.dataview.data.get('description').get('elemID').value = 'log2';
    mainview.controlview.insertListener();
    ...
    chai.assert.equal(mainview.dataview.data.get('description').get('elemID').value, 'log');
    chai.assert.equal(mainview.controlview.db.getRec(3), undefined);
    chai.assert.equal(mainview.controlview.db.getRec(4).get('description'), 'log2');
  });
});
